...
PROJECT_NAME ?= provider-nebraska
...
export TERRAFORM_PROVIDER_SOURCE ?= utilitywarehouse/nebraska
export TERRAFORM_PROVIDER_REPO ?= https://github.com/utilitywarehouse/terraform-provider-nebraska
export TERRAFORM_PROVIDER_VERSION ?= 0.1.5
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-nebraska
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-nebraska_v0.1.5
...
xpkg.build.provider-nebraska: do.build.images
